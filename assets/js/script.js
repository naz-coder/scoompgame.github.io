...
const questions = [
  ...
  {
    question: "In Africa which country has the highest population of tall people?",
    answers: [
  ...
  {
    question: "Among these options, one of them is not a Car brand.",
    answers: [
      { text: "Camry", correct: false },
      { text: "Fendi", correct: false },
      { text: "Mitsubichi", correct: false },
